...
namespace Synzeal_Qty_Update.Folder
{
    ...
    public partial class Synzeal_LiveDataEntities : DbContext
    {
        public Synzeal_LiveDataEntities()
            : base("name=Synzeal_LiveDataEntities")
        {
        ...
        public virtual DbSet<InccoTerm> InccoTerms { get; set; }
        ...
        public virtual DbSet<MissiveResponse> MissiveResponses { get; set; }
        ...
        public virtual DbSet<SZ_AdditionalTest> SZ_AdditionalTest { get; set; }
        public virtual DbSet<SZ_Bug> SZ_Bug { get; set; }
        ...
        public virtual DbSet<SZ_Clientremark> SZ_Clientremark { get; set; }
        public virtual DbSet<SZ_ClubQuote> SZ_ClubQuote { get; set; }
        public virtual DbSet<SZ_CompanyAddress> SZ_CompanyAddress { get; set; }
        ...
        public virtual DbSet<SZ_Geographical> SZ_Geographical { get; set; }
        public virtual DbSet<SZ_HSNCode> SZ_HSNCode { get; set; }
        ...
        public virtual DbSet<SZ_InvoiceDocument> SZ_InvoiceDocument { get; set; }
        public virtual DbSet<SZ_Log> SZ_Log { get; set; }
        public virtual DbSet<SZ_MasterCOA> SZ_MasterCOA { get; set; }
        public virtual DbSet<SZ_Meeting> SZ_Meeting { get; set; }
        public virtual DbSet<SZ_NameMaster> SZ_NameMaster { get; set; }
        public virtual DbSet<SZ_Notification> SZ_Notification { get; set; }
        public virtual DbSet<SZ_PerformaInvoice> SZ_PerformaInvoice { get; set; }
        public virtual DbSet<SZ_PerformaInvoiceDetailsData> SZ_PerformaInvoiceDetailsData { get; set; }
        public virtual DbSet<SZ_Physicalstate> SZ_Physicalstate { get; set; }
        public virtual DbSet<SZ_Popup> SZ_Popup { get; set; }
        public virtual DbSet<SZ_PopupGroup> SZ_PopupGroup { get; set; }
        public virtual DbSet<SZ_PopupGroupEmailList> SZ_PopupGroupEmailList { get; set; }
        public virtual DbSet<SZ_Price> SZ_Price { get; set; }
        public virtual DbSet<SZ_PriceList> SZ_PriceList { get; set; }
        public virtual DbSet<SZ_ProductScheme> SZ_ProductScheme { get; set; }
        public virtual DbSet<SZ_Project> SZ_Project { get; set; }
        public virtual DbSet<SZ_ProjectDetail> SZ_ProjectDetail { get; set; }
        public virtual DbSet<SZ_PRRequest> SZ_PRRequest { get; set; }
        public virtual DbSet<SZ_PurchaseRFQ> SZ_PurchaseRFQ { get; set; }
        public virtual DbSet<SZ_PurchaseSupplierCatalogue> SZ_PurchaseSupplierCatalogue { get; set; }
        ...
        public virtual DbSet<SZ_QuotationPDF> SZ_QuotationPDF { get; set; }
        public virtual DbSet<SZ_QuoteDetail_Correctionlog> SZ_QuoteDetail_Correctionlog { get; set; }
        public virtual DbSet<SZ_QuoteDetailForm> SZ_QuoteDetailForm { get; set; }
        public virtual DbSet<SZ_QuoteDetailPrice> SZ_QuoteDetailPrice { get; set; }
        ...
        public virtual DbSet<SZ_QuoteDetailsControlSubstance> SZ_QuoteDetailsControlSubstance { get; set; }
        public virtual DbSet<SZ_QuoteSummary> SZ_QuoteSummary { get; set; }
        public virtual DbSet<SZ_ReactionMatrix> SZ_ReactionMatrix { get; set; }
        public virtual DbSet<SZ_ReservedQty> SZ_ReservedQty { get; set; }
        public virtual DbSet<SZ_Retest> SZ_Retest { get; set; }
        public virtual DbSet<SZ_Rule> SZ_Rule { get; set; }
        public virtual DbSet<SZ_RuleDetail> SZ_RuleDetail { get; set; }
        public virtual DbSet<SZ_SampleReason> SZ_SampleReason { get; set; }
        ...
        public virtual DbSet<SZ_SAPCASNo> SZ_SAPCASNo { get; set; }
        public virtual DbSet<SZ_SAPProjectNameData> SZ_SAPProjectNameData { get; set; }
        public virtual DbSet<SZ_SAPRawMaterial> SZ_SAPRawMaterial { get; set; }
        public virtual DbSet<SZ_ScientistStatus> SZ_ScientistStatus { get; set; }
        public virtual DbSet<SZ_Slogan> SZ_Slogan { get; set; }
        public virtual DbSet<SZ_SolutionModule> SZ_SolutionModule { get; set; }
        public virtual DbSet<SZ_SOP> SZ_SOP { get; set; }
        public virtual DbSet<SZ_Survey> SZ_Survey { get; set; }
        public virtual DbSet<SZ_SystemNotification> SZ_SystemNotification { get; set; }
        ...
        public virtual DbSet<SZ_UserManagement> SZ_UserManagement { get; set; }
        ...
        [DbFunction("Synzeal_LiveDataEntities", "nop_splitstring_to_table")]
        public virtual IQueryable<nop_splitstring_to_table_Result> nop_splitstring_to_table(string @string, string delimiter)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<nop_splitstring_to_table_Result>("[Synzeal_LiveDataEntities].[nop_splitstring_to_table](@string, @delimiter)", stringParameter, delimiterParameter);
        }
        ...
        public virtual ObjectResult<InvoiceList_Result> InvoiceList(string countryType, string searchString, string internationcompanylist, string controlledsubstance, string startdate, string enddate, Nullable<int> pageNumber, Nullable<int> pageSize)
        {
            ...
            var controlledsubstanceParameter = controlledsubstance != null ?
                new ObjectParameter("controlledsubstance", controlledsubstance) :
                new ObjectParameter("controlledsubstance", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<InvoiceList_Result>("InvoiceList", countryTypeParameter, searchStringParameter, internationcompanylistParameter, controlledsubstanceParameter, startdateParameter, enddateParameter, pageNumberParameter, pageSizeParameter);
        }
        ...
        public virtual ObjectResult<QuotationList_Result> QuotationList(string searchString, string company, string date, string countrytype, string tabName, string searchby, string searchbyvalue, string internationcompanylist, string startdate, string enddate, string emailAddress, Nullable<decimal> startQuoteValue, Nullable<decimal> endQuoteValue, Nullable<int> pageNumber, Nullable<int> pageSize)
        {
            var searchStringParameter = searchString != null ?
                new ObjectParameter("searchString", searchString) :
                new ObjectParameter("searchString", typeof(string));
            ...
            var startQuoteValueParameter = startQuoteValue.HasValue ?
                new ObjectParameter("startQuoteValue", startQuoteValue) :
                new ObjectParameter("startQuoteValue", typeof(decimal));
    
            var endQuoteValueParameter = endQuoteValue.HasValue ?
                new ObjectParameter("endQuoteValue", endQuoteValue) :
                new ObjectParameter("endQuoteValue", typeof(decimal));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<QuotationList_Result>("QuotationList", searchStringParameter, companyParameter, dateParameter, countrytypeParameter, tabNameParameter, searchbyParameter, searchbyvalueParameter, internationcompanylistParameter, startdateParameter, enddateParameter, emailAddressParameter, startQuoteValueParameter, endQuoteValueParameter, pageNumberParameter, pageSizeParameter);
        }
        ...
        public virtual ObjectResult<QuotationList_12052022_Result> QuotationList_12052022(string searchString, string company, string date, string countrytype, string tabName, string searchby, string searchbyvalue, Nullable<int> pageNumber, Nullable<int> pageSize)
        {
            var searchStringParameter = searchString != null ?
                new ObjectParameter("searchString", searchString) :
                new ObjectParameter("searchString", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<QuotationList_12052022_Result>("QuotationList_12052022", searchStringParameter, companyParameter, dateParameter, countrytypeParameter, tabNameParameter, searchbyParameter, searchbyvalueParameter, pageNumberParameter, pageSizeParameter);
        }
        ...
        public virtual ObjectResult<QuotationList_OLD_Result> QuotationList_OLD(string searchString, string company, string date, string countrytype, string tabName, string searchby, string searchbyvalue, Nullable<int> pageNumber, Nullable<int> pageSize)
        {
            var searchStringParameter = searchString != null ?
                new ObjectParameter("searchString", searchString) :
                new ObjectParameter("searchString", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<QuotationList_OLD_Result>("QuotationList_OLD", searchStringParameter, companyParameter, dateParameter, countrytypeParameter, tabNameParameter, searchbyParameter, searchbyvalueParameter, pageNumberParameter, pageSizeParameter);
        }
