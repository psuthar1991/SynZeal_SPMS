...
namespace Synzeal_Export_Catalogue.Model
{
    public class ITextEvents : PdfPageEventHelper
    {
        ...
        public ITextEvents(string APIname, bool isImage)
        {
            _apiname = APIname;
            _isImage = isImage;
        }
        ...
        public override void OnEndPage(iTextSharp.text.pdf.PdfWriter writer, iTextSharp.text.Document document)
        {
            ...
            //Add paging to footer
            {
                cb.BeginText();
                cb.SetFontAndSize(bf, 12);
                cb.SetTextMatrix(document.PageSize.GetLeft(30), document.PageSize.GetBottom(15));
                cb.ShowText("ISO 9001:2015 | ISO 17025 | Visit us at www.synzeal.com or e-mail to standards@synzealcom");
                cb.EndText();
                float len = bf.GetWidthPoint(text, 12);
                cb.AddTemplate(footerTemplate, document.PageSize.GetLeft(30) + len, document.PageSize.GetBottom(15));
            }
