...
namespace Synzeal_SAP_Stock_API.Entity
{
    ...
    public partial class SynzealLiveEntities : DbContext
    {
        ...
        public virtual ObjectResult<InvoiceList_Result> InvoiceList(string countryType, string searchString, Nullable<int> pageNumber, Nullable<int> pageSize)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<InvoiceList_Result>("InvoiceList", countryTypeParameter, searchStringParameter, pageNumberParameter, pageSizeParameter);
        }
        ...
        public virtual ObjectResult<QuotationList_Result> QuotationList(string searchString, string company, string date, string countrytype, string tabName, string searchby, string searchbyvalue, Nullable<int> pageNumber, Nullable<int> pageSize)
        {
            var searchStringParameter = searchString != null ?
                new ObjectParameter("searchString", searchString) :
                new ObjectParameter("searchString", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<QuotationList_Result>("QuotationList", searchStringParameter, companyParameter, dateParameter, countrytypeParameter, tabNameParameter, searchbyParameter, searchbyvalueParameter, pageNumberParameter, pageSizeParameter);
        }
