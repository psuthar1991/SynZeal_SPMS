...
namespace Synzeal_AutoBackup.Entity
{
    ...
    public partial class Synzeal_22112019Entities : DbContext
    {
        public Synzeal_22112019Entities()
            : base("name=Synzeal_22112019Entities")
        {
        ...
        [DbFunction("Synzeal_22112019Entities", "nop_splitstring_to_table")]
        public virtual IQueryable<nop_splitstring_to_table_Result> nop_splitstring_to_table(string @string, string delimiter)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<nop_splitstring_to_table_Result>("[Synzeal_22112019Entities].[nop_splitstring_to_table](@string, @delimiter)", stringParameter, delimiterParameter);
        }
        ...
        public virtual ObjectResult<InvoiceList_Result> InvoiceList(string searchString, Nullable<int> pageNumber, Nullable<int> pageSize)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<InvoiceList_Result>("InvoiceList", searchStringParameter, pageNumberParameter, pageSizeParameter);
        }
        ...
        public virtual ObjectResult<QuotationList_Result> QuotationList(string searchString, string tabName, Nullable<int> pageNumber, Nullable<int> pageSize)
        {
            var searchStringParameter = searchString != null ?
                new ObjectParameter("searchString", searchString) :
                new ObjectParameter("searchString", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<QuotationList_Result>("QuotationList", searchStringParameter, tabNameParameter, pageNumberParameter, pageSizeParameter);
        }
