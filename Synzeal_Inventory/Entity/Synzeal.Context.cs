...
namespace Synzeal_Inventory.Entity
{
    ...
    public partial class SynzealLiveEntities : DbContext
    {
        public SynzealLiveEntities()
            : base("name=SynzealLiveEntities")
        {
        }
        ...
        [DbFunction("SynzealLiveEntities", "nop_splitstring_to_table")]
        public virtual IQueryable<nop_splitstring_to_table_Result> nop_splitstring_to_table(string @string, string delimiter)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<nop_splitstring_to_table_Result>("[SynzealLiveEntities].[nop_splitstring_to_table](@string, @delimiter)", stringParameter, delimiterParameter);
        }
        ...
        public virtual ObjectResult<QuotationList_Result> QuotationList(string searchString, string company, string date, string countrytype, string tabName, string searchby, string searchbyvalue, string internationcompanylist, string startdate, string enddate, string emailAddress, Nullable<decimal> startQuoteValue, Nullable<decimal> endQuoteValue, string geographicalId, string controlled, string poReceived, string csinstock, string userDist, string important, Nullable<int> pageNumber, Nullable<int> pageSize)
        {
            var searchStringParameter = searchString != null ?
                new ObjectParameter("searchString", searchString) :
                new ObjectParameter("searchString", typeof(string));
            ...
            var geographicalIdParameter = geographicalId != null ?
                new ObjectParameter("GeographicalId", geographicalId) :
                new ObjectParameter("GeographicalId", typeof(string));
    
            var controlledParameter = controlled != null ?
                new ObjectParameter("controlled", controlled) :
                new ObjectParameter("controlled", typeof(string));
    
            var poReceivedParameter = poReceived != null ?
                new ObjectParameter("poReceived", poReceived) :
                new ObjectParameter("poReceived", typeof(string));
    
            var csinstockParameter = csinstock != null ?
                new ObjectParameter("csinstock", csinstock) :
                new ObjectParameter("csinstock", typeof(string));
    
            var userDistParameter = userDist != null ?
                new ObjectParameter("userDist", userDist) :
                new ObjectParameter("userDist", typeof(string));
